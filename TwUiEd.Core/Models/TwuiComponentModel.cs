...
namespace TwUiEd.Core.Models
{
    ...
    public class TwuiComponentModel : TwuiBaseComponentModel
    {
        ...
        public TwuiPropertyModel Id { get; set; } = new(typeof(string), string.Empty);

        [TwuiProperty("tooltipslocalised")]
        public TwuiPropertyModel TooltipsLocalised { get; set; } = new(typeof(bool), false);
        ...
        public TwuiPropertyModel ClipChildren { get; set; } = new(typeof(bool), false);

        //public TwuiPropertyModel<ValueTuple<float, float>> Offset { get; set; } = new((0.0f,0.0f));
        public TwuiPropertyModel Offset { get; set; } = new(typeof(ValueTuple<float, float>), (0.0f,0.0f));
        ...
        public ObservableCollection<TwuiPropertyModel> Properties { get; set; } = [];
